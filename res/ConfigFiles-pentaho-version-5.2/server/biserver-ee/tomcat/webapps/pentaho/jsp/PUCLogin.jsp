...
<div id="login-wrapper">
  <div id="login-background">
    <div id="oemdemo" style="background-color:yellow; align: center;"><a href="/oemdemo">OEM Embedded Example</a></div>
...
<div id="systemDown" class="pentaho-dialog">
  <div class="dialogTopCenterInner">
    <div class="Caption">
      <%=Messages.getInstance().getString("UI.PUC.SYSTEM.DOWN.CAPTION")%>
    </div>
  </div>
  <div class="dialogMiddleCenterInner">
    <div class="dialog-content pentaho-padding-sm">
      <%=Messages.getInstance().getString("UI.PUC.SYSTEM.DOWN")%>
    </div>
  </div>
  <div class="dialogMBottomCenterInner">
    <div class="button-panel">
      <button class="btn pull-right" onclick="document.getElementById('systemDown').style.display='none'"><%=Messages.getInstance().getString("UI.PUC.LOGIN.CLOSE")%></button>
    </div>
  </div>
</div>
